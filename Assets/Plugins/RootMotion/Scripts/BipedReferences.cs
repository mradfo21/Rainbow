...
namespace RootMotion {
	...
	public class BipedReferences {
		...
		/// </summary>
		public static bool CheckSetupError(BipedReferences references, bool log = true) {
		...
		/// </summary>
		public static bool CheckSetupWarning(BipedReferences references, bool log = true) {
