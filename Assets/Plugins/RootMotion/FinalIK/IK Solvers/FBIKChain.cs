...
namespace RootMotion.FinalIK {
	...
	public class FBIKChain {
		...
		public void SolveTrigonometric(FBIKChain[] chain) {
			...
			Vector3 bendDirection = GetBendDirection(direction, maxMag, nodes[0].length, nodes[1].length);
		 ...
		 * */
		protected Vector3 GetBendDirection(Vector3 direction, float directionMagnitude, float length1, float length2) {
			float sqrMag1 = length1 * length1;
			float sqrMag2 = length2 * length2;
