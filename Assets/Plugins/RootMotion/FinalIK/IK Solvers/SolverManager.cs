...
namespace RootMotion.FinalIK {
	...
	public class SolverManager: MonoBehaviour {
		...
		private bool animatePhysics {
			get {
				if (animator != null) return animator.animatePhysics;
		...
		private void Initiate() {
			...
			FindAnimatorRecursive(transform);
		...
		private void FindAnimatorRecursive(Transform t) {
			animator = t.GetComponent<Animator>();
			animation = t.GetComponent<Animation>();

			if (!isAnimated && t.parent != null) FindAnimatorRecursive(t.parent);
		}
