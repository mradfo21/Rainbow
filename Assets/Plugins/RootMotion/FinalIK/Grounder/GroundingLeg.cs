	...
	public partial class Grounding {
		...
		public class Leg {
			...
			public void Process() {
				...
				prediction = Vector3.Lerp(prediction, velocity * grounding.prediction, deltaTime * grounding.predictionAcceleration);
			...
			private RaycastHit GetCapsuleHit(Vector3 offsetFromHeel) {
				...
				Physics.CapsuleCast(capsuleStart - offsetFromHeel, capsuleEnd, grounding.footRadius, -up, out hit, grounding.maxStep * 3, grounding.layers);
				return hit;
			}
